...
%% trajektorie 35 stopni w lewo
f1=figure;hold on;axis equal;grid on;
rudderNumber=15;
title("Zderzenie statków, statek własny 35° lewo");
xlabel('Y [m]');
ylabel('X [m]');
...
%% trajektorie 0 stopni środek ster
f2=figure;hold on;axis equal;grid on;
rudderNumber=8;
title("Zderzenie statków, statek własny środek ster");
xlabel('Y [m]');
ylabel('X [m]');
h2Y=wyniki(scenario,rudderNumber,:,7);
isNZ=(~h2Y==0);
...
%% trajektorie 35 stopni w prawo
f3=figure;hold on;axis equal;grid on;
rudderNumber=1;
title("Zderzenie statków, statek własny 35° prawo");
xlabel('Y [m]');
ylabel('X [m]');
h2Y=wyniki(scenario,rudderNumber,:,7);
isNZ=(~h2Y==0);
