...
if nnn > requiredCPA
    disp(['Zasymulowany kooperacyjny manewr ostatniej chwili w wariancie ' ...
        manewr ' jest skuteczny, osiągnięta odległość minięcia między obrysami to ' num2str(nnn) ' m, wymagano ' num2str(requiredCPA) ' m, odległość minięcia między punktami to ' num2str(wyniki(zzz,5)) ' m.']);
    disp(['Czas do osiągnięcia kooperacyjnego punktu bez ucieczki dla statku własnego: ' num2str(elapsedTime) ' s.']);
    disp(['Odległość między statkami w momencie rozpoczęcia wyznaczonego kooperacyjnego manewru ostatniej chwili '...
        'pomiędzy punktami to ' num2str(distPBU2) ' m, natomiast między obrysami to ' num2str(distPBU1) ' m.']);
    disp(['Pozycja kooperacyjnego punktu bez ucieczki dla statku własnego to P=(' num2str(aaa2.x) ' m,' num2str(aaa2.y) ' m).']);
    disp(['Pozycja kooperacyjnego punktu bez ucieczki dla statku obcego to P=(' num2str(bbb2.x) ' m,' num2str(bbb2.y) ' m).']);
else
