classdef ship3
    ...
    properties
        ...
        hydroCoefficientLevel %je�li "0" to uproszczone liniowe, je�li "1" to nieliniowe proste, je�li "2" to nieliniowe z�o�one
        ...
        breadth
        draught
        cB %wsp�czynnik pe�notliwo�ci podwodzia
        sW %powierzchnia zwil�ona kad�uba
        xG  %wsp�rz�dna �rodka ci�ko�ci od midshipu
        yG
        zG %wsp�rzena �rodka ci�ko�ci od p�aszczyzny podstawowej
        GM  %pocz�tkowa wysoko�� metacentryczna
        KG %wzniesienie punktu metacentrycznego
        rXX %ramienia moment�w bezw�ado�ci masy wok� osi x y z
        rYY
        rZZ
        % air resistance
        airAreaX
        ...
        %% DANE P�DNIKA / PROPELLER DETAILS
        propellerDiameter %�rednica
        propellerRotation
        pd %
        AeA0 %
        propellerZ %liczba ostrzy
        propellerNo %liczba �rub
        xP %wsp�rz�dna po�o�enia �ruby od midshipu
        kT0 %wsp�rz�dne wielomianu drugiego stopnia kt�rym aproksymuje si� krzyw� charakterystyki �ruby
        kT1 
        kT2
        thrustDeduction
        wakeFraction
        ...
        cTH
        cTHDrop
        % jakie� tam wsp�czynniki korekcyjne
        tR
        aH
        xR
        xH
        ...
        rudderC2Pos
        rudderC2Neg
        %% WSPӣCZYNNIKI HYDRODYNAMICZNE / HYDRODYNAMIC COEFFICIENTS
        shipAspectRatio
        ...
        N_vvr
        hydroSet
        %% MASA, MASY DODANE, MOMENTY BEZW�ADNO�CI I MOMENTY BEZW�ADNO�CI DODANE
        m
        Ixx
        Iyy 
        Izz
        ...
        %% DYNAMIKA
        %macierze- masy, przyspiesze�, si�, coriolisa, pr�dko�ci
        M
        Acc
        P
        C
    ...
    methods
        ...
        function s = ship3(shipName, shipData, shipVector, steeringVector, ...
            ...
            % Uzupe�nienie zbioru wsp�czynnik�w hydrodynamicznych
            s.hydroSet(1)=s.X_vv;
            s.hydroSet(2)=s.X_vr;
            s.hydroSet(3)=s.X_rr;
        ...
        %% pojedyncze wyliczenia si� i moment�w
        ...
        %% CA�O�CIOWE OBLICZENIA HYDRODYNAMICZNE
