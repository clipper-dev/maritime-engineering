function c = shipDefault2(shipName, colour)
...
c = shipLoad3(shipName, shipVector, steeringVector, calculusVector, initialStateVector1, environmentVector,colour,'rect2');
end